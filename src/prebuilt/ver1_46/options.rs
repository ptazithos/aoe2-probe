...
impl Options {
    pub fn template() -> Token {
        ...
        root.push_back("unknown_1", vec![(0 as u32).into(); 8]);
        ...
        root.push_back("unknown_2", vec![(0 as u32).into(); 8]);
        ...
        root.push_back("unknown_3", vec![(0 as u32).into(); 8]);
        ...
        root.push_back("combat_mode", 0 as u32);
        root.push_back("naval_mode", 0 as u32);
        root.push_back("all_techs", 0 as u32);
        root.push_back("per_player_starting_age", vec![(0 as u32).into(); 16]);
        root.push_back("unknown_4", vec![(0 as u8).into(); 17]);
        root.push_back("per_player_base_priority", vec![(0 as u8).into(); 8]);
        root.push_back("unknown_5", vec![(0 as u8).into(); 7]);
        root.push_back("number_of_triggers", 0 as u32);
